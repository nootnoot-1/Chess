...
/**
 * dataAccess.Database is responsible for creating connections to the database. Connections are
 ...
 *
 * <pre>
 *  public boolean example(String selectStatement, dataAccess.Database db) throws DataAccessException{
...
public class Database {
    ...
    private static final String DB_PASSWORD = "imightbelate1";
